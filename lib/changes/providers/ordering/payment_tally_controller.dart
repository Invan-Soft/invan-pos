...
class PaymentTallyController {
  ...
  ///
  /// Kassir klaviaturada tergan [parsed] qoldiqdan katta bo'lsa, qoldiq
  /// qaytariladi (ortiqcha to'lov yozilmaydi). [parsed] 0 bo'lsa —
  /// "hammasi" ma'nosida butun qoldiq.
  ///
  /// Click / Payme / Uzum / Paynet yo'llari shuni ishlatadi.
  ///
  /// QAYD (4-qoida — tuzatilmadi): chekda SHU tur bo'yicha allaqachon
  /// kiritilgan summa AYIRILMAYDI. `allPaymentType` yangi qiymatni
  /// eskisining USTIGA qo'yadi, shuning uchun tugma ikki marta bosilsa
  /// summa oshib ketishi mumkin — cashback'da aynan shu xato bo'lgan
  /// (`docs/sessions/2026-08-12-cashback-overspend-fix.md`). Bu yerda
  /// hozirgi xatti-harakat o'zgartirilmasdan muzlatildi
  /// (`test/payment_amount_rules_test.dart`).
